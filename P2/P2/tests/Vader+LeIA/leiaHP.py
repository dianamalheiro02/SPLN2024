...
def analyze_text_sentiment(filename, output_file):
    try:
        ...
        # Initialize the Leia sentiment intensity analyzer
        ...
        with open(output_file, 'a', encoding='utf-8') as out_file:
            ...
            analysis_number = sum(1 for line in open(output_file, 'r', encoding='utf-8') if line.startswith('# Analysis #')) + 1
...
if __name__ == "__main__":
    ...
    output_file = "outLeia.txt"  # Output file where results are appended
