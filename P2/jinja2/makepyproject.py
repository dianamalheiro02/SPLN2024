...
# version = jjcli.qx(f"grep __version__ '{name}.py'") -> faz a mesma coisa!!!!!
version = None
if python_files:
...
#Se não, version tem que estar aqui
pp = jinja2.Template('''
...
#FIX ME
print(pp.render({"name":name,"autor":"Diana","email":"pg53766@alunos.uminho.pt"}))
